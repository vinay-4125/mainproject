      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="#" className="flex items-center">
            ...
            <span className="self-center text-3xl font-semibold whitespace-nowrap select-none">
              Anna Purna
            </span>
          </a>
          <div className="flex md:order-1">
            <div className="hidden relative w-96 mr-3 md:mr-0 md:block">
          ...
          >
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              ...
              <Link href="/">
                <a
                  className="block py-2 pr-4 pl-3 text-gray-700 bg-blue-700 rounded md:bg-transparent md:hover:text-blue-700 md:p-0 "
                  aria-current="page"
                >
                  Home
                </a>
